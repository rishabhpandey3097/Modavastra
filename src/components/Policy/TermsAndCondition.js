  ...
  return (
    <>
      ...
      <div className="terms-container">
        ...
        <p>Welcome to Modavastra !</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Modavastra fashion tech pvt ltd's Website, located at
          Modavastra.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Modavastra if you do not agree to
        ...
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By accessing Modavastra , you agreed to
          use cookies in agreement with the Modavastra fashion tech pvt ltd's
          Privacy Policy.
        </p>
        <p>
        ...
        <h3>License</h3>
        <p>
          Unless otherwise stated, Modavastra fashion tech pvt ltd and/or its
          licensors own the intellectual property rights for all material on
          Modavastra . All intellectual property rights are reserved. You may
          access this from Modavastra for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not: </p>
        <ul>
          <li>Republish material from Modavastra Sell,</li>
          <li>rent or sub-license material from Modavastra </li>
          <li>Reproduce,duplicate or copy material from Modavastra</li>
          <li>Redistribute content from Modavastra</li>
        </ul>
        <p>
        ...
        <p>
          ...
          Modavastra fashion tech pvt ltd does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do
          not reflect the views and opinions of Modavastra fashion tech pvt
          ...
          extent permitted by applicable laws, Modavastra fashion tech pvt ltd
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          Modavastra fashion tech pvt ltd reserves the right to monitor all
        ...
        <p>
          You hereby grant Modavastra fashion tech pvt ltd a non-exclusive
        ...
        <ul>
          ...
          <li>internet portals; accounting, law and consulting firms; and</li>
        ...
        <p>
          ...
          the hyperlink compensates the absence of Modavastra fashion tech pvt
        ...
        <p>
          ...
          sending an e-mail to Modavastra fashion tech pvt ltd. Please include
        ...
        <ul>
          ...
          <li>
            or By use of any other description of our Website being linked to
            that makes sense within the context and format of content on the
            linking party’s site.
          </li>
        </ul>
        <p>
          No use of Modavastra fashion tech pvt ltd's logo or other artwork will
