    ...
    return (
        <footer>
            <ul className='footer-moda-details'>
                <li><a href="#"><img src={modalogo} alt=""></img></a></li>
            ...
            <ul className='footer-shop-now'>
                ...
                <li> <a href="#">Design Your Own Outfit</a></li>
            ...
            <ul className='footer-collaborations'>
                ...
                <li> <a href="#">Become our Creator</a></li>
            ...
            <ul className='footer-follow-us'>
                ...
                <li className='footer-social-links'> 
                    <a href="www.instragram.com"><img src={instragram}></img></a>
                    <a href="www.facebook.com"><img src={facebook}></img></a>
                    <a href="www.linkedin.com"><img src={linkedin}></img></a>
                    <a href="www.twitter.com"><img src={twitter}></img></a>
                </li>
            </ul>
        </footer>
    );
